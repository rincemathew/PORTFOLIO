  ...
  return (
    <section className="project" id="portfolio">
      <ul className="project-list">
        ...
        <li>
          <a href="https://marvelwears.onrender.com/" className="project-card">
            <figure className="card-banner">
              <img src="/assets/images/prjct7.jpg" className="w-100" alt="A fujifilm instant camera on a dark electric blue background." />
            </figure>
            <div className="card-content">
              <h3 className="h4 card-title">MarvelWears.shop</h3>
        ...
        <li>
          <a href="https://rincemathew.github.io/Simple_Calculator/" className="project-card">
            <figure className="card-banner">
              <img src="/assets/images/prjct1.jpg" className="w-100" alt="A macintosh on a yellow background." />
            </figure>
            <div className="card-content">
        ...
        <li>
          <a href="https://rincemathew.github.io/Snake-Game-Demo/" className="project-card">
            <figure className="card-banner">
              <img src="/assets/images/prjct2.jpg" className="w-100" alt="On a Blue background, a Wacom and a mouse." />
            </figure>
            <div className="card-content">
        ...
        <li>
          <a href="https://rincemathew.github.io/Hulu-Home-page-clone/" className="project-card">
            <figure className="card-banner">
              <img src="/assets/images/prjct3.jpg" className="w-100" alt="A Cassette tape on a mellow apricot background." />
            </figure>
            <div className="card-content">
        ...
        <li>
          <a href="https://rincemathew.github.io/BMW-cycles-clone/" className="project-card">
            <figure className="card-banner">
              <img src="/assets/images/prjct4.jpg" className="w-100" alt="Blue digital watch on a dark liver background." />
            </figure>
            <div className="card-content">
        ...
        <li>
          <a href="https://rincemathew.github.io/ToDo-List/" className="project-card">
            <figure className="card-banner">
              <img src="/assets/images/prjct5.jpg" className="w-100" alt="On a dark liver background, Airport luggage car carrying a luggage." />
            </figure>
            <div className="card-content">
        ...
        <li>
          <a href="https://rincemathew.github.io/Netflix-Clone-using-React/" className="project-card">
            <figure className="card-banner">
              <img src="/assets/images/netflix.jpg" className="w-100" alt="On a dark liver background, Airport luggage car carrying a luggage." />
            </figure>
            <div className="card-content">
        ...
        <li>
          <a href="https://rincemathew.github.io/Amazon-prime-video-clone/" className="project-card">
            <figure className="card-banner">
              <img src="/assets/images/prjct6.jpg" className="w-100" alt="A fujifilm instant camera on a dark electric blue background." />
            </figure>
            <div className="card-content">
